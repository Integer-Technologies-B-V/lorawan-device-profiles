...
(function (codec) {
    var TempV30x57Parser = (function () {
        ...
        TempV30x57Parser.prototype.parseFrame = function (payload, configuration, network) {
            ...
            var temperatures = [];
            var ch1Temp = [], ch2Temp = [];
            for (var offset = 2; offset < payload.length; offset += 2 * nbSensors) {
...
var codec;
(function (codec) {
    var TempV3StatusByteParser = (function () {
...
(function (codec) {
    var Decoder = (function (_super) {
        ...
        function Decoder() {
            ...
            _this.deviceType = 'temp3';
            return _this;
        }
        Decoder.prototype.getActiveParsers = function (frameCode) {
            var activeParsers = [];
            var statusByteParsers = new codec.TempV3StatusByteParser();
            var dataParser;
            switch (frameCode) {
                case 0x10:
                    dataParser = new codec.TempV30x10Parser();
                    break;
                case 0x30:
                    dataParser = new codec.TempV30x30Parser();
                    break;
                case 0x57:
                    dataParser = new codec.TempV30x57Parser();
                    break;
                case 0x58:
                    dataParser = new codec.TempV30x58Parser();
                    break;
                case 0x20:
